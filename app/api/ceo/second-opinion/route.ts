...
Score out of 10. Can a busy client executive, reading this once, immediately understand what you do, why you are uniquely qualified for this brief, and what specific outcomes they will get? Explain exactly what creates ambiguity.
...
Rules: No hashtags. No emojis. Client-grade directness — not agency-internal cheerleading.`
    ...
    case 'conversation_preparer':
      prompt = `You are an executive coach who specialises in preparing CEOs and senior leaders for high-stakes conversations. You have coached leaders through client exits, team restructurings, performance conversations, partnership breakdowns, and salary negotiations.
...
Write the exact opening sentence — the specific words to say in the first 15 seconds. This sentence must: acknowledge reality, signal respect, and create space for dialogue.
