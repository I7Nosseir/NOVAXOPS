...
- A format: "The Hidden Cost" (repeatable â€” every episode names a real cost of something the audience pursues, revealing the thing no one talks about)

A great format has three properties:
1. REPEATABILITY â€” can be used 20+ times without becoming stale because the variable (the topic) changes while the structure stays constant
2. IDENTITY SIGNAL â€” the audience self-selects immediately ("this is for someone like me")
3. SHAREABILITY MECHANISM â€” a psychological reason to forward it built into the structure itself

FRAMEWORK APPLICATION:

1. HOOK STACK â€” 2â€“4 hook types used in sequence. Each one amplifies the previous.
...
2. THREE-LAW VALIDATION:
   - Law of Pattern Interrupt: Does the format's structure visually or verbally break the feed scroll? Not just the content â€” the FORMAT itself.
   - Law of Incomplete Information: Does the format's structure force watching/reading to the end? (Not just hoping the content is interesting â€” is there a structural reason the end is needed?)
...
3. EPISODE STRUCTURE â€” 5â€“7 ordered beats. Each beat has a job. Name the job, not just the content.
   Example: "Beat 1: Name the trap (hook) â†’ Beat 2: Prove the trap is real (evidence) â†’ Beat 3: Make the audience admit they've been in it (identity) â†’ Beat 4: The escape (value) â†’ Beat 5: The cost of NOT escaping (urgency) â†’ Beat 6: Low-friction CTA (next step)"

4. PAYOFF ARCHITECTURE â€” what specific emotion does the audience feel at the LAST second?
...
5. EXAMPLE HOOKS â€” 3 specific hook examples using this format for the "${niche}" niche. These should be usable tomorrow.

6. AUDIENCE PSYCHOLOGY â€” one sentence describing the specific psychological state the audience is in when this format performs best (e.g. "Works best when the audience is in a state of quiet dissatisfaction â€” not acute crisis, not contentment")

7. WHAT KILLS IT â€” the single execution mistake that makes this format fail. Not generic ("bad content") â€” the SPECIFIC mistake unique to this format's structure.
  ...
  "formats": [
    {
      ...
      "episode_structure": ["Beat 1: job â€” description", "Beat 2: job â€” description", "Beat 3: job â€” description", "Beat 4: job â€” description", "Beat 5: job â€” description"],
      "payoff_architecture": "The specific emotion the audience feels at the last second, and what produces it",
      "why_viral": "The specific psychological mechanism that makes this spread â€” name the bias or drive",
...
- Example hooks must be specific and ready to use â€” not placeholder text
`
