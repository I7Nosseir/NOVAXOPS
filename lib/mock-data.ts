...
export const ASSETS: Asset[] = [
  { id: 'a1', task_id: 't10', source: 'freepik', type: 'image', file_url: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=800', thumbnail_url: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=300', license_info: 'Freepik Premium', title: 'Luxury cosmetics flat lay', created_at: '2025-04-30' },
  { id: 'a2', task_id: 't10', source: 'freepik', type: 'image', file_url: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=800', thumbnail_url: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=300', license_info: 'Freepik Premium', title: 'Beauty product skincare', created_at: '2025-04-30' },
  { id: 'a3', task_id: 't11', source: 'freepik', type: 'illustration', file_url: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800', thumbnail_url: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=300', license_info: 'Freepik Free', title: 'Fitness workout gym', created_at: '2025-04-29' },
  { id: 'a4', task_id: 't9', source: 'freepik', type: 'image', file_url: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800', thumbnail_url: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=300', license_info: 'Freepik Premium', title: 'Fresh seafood coastal dish', created_at: '2025-04-28' },
